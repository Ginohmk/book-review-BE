...
regd_users.put('/auth/review/:isbn', (req, res) => {
  ...
  return res.status(200).json({ data: filteredBook.reviews });
});
...
regd_users.delete('/auth/review/:isbn', (req, res) => {
  ...
  if (!username.includes(Object.keys(filteredBook.reviews))) {
    //User has no review on book
    return res.status(208).json({ message: 'You can not delete this review' });
  } else {
    // Delete review
